       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="generateQr.php">Generate QR Attendance</a>
            ...
            <a class="collapse-item" href="downloadRecord.php">Today's Full Report (xls)</a>
            <a class="collapse-item" href="downloadRecord.php?statusFilter=present">Today's Present Report (xls)</a>
            <a class="collapse-item" href="downloadRecord.php?statusFilter=absent">Today's Absent Report (xls)</a>
