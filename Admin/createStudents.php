...
if(isset($_POST['save'])){
  ...
  $defaultPasswordHash = password_hash($admissionNumber, PASSWORD_DEFAULT);
    ...
    value('$firstName','$lastName','$otherName','$admissionNumber','$defaultPasswordHash','$classId','$classArmId','$dateCreated')");

    if ($query) {
        
                $statusMsg = "<div class='alert alert-success'  style='margin-right:700px;'>Created Successfully! Default password is the Admission Number.</div>";
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    otherName='$otherName', admissionNumber='$admissionNumber',password='$defaultPasswordHash', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
