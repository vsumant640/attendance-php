...
<head>
  ...
  <title><?php echo BRAND_SHORT_NAME; ?> - Teacher Login</title>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <img src="img/logo/<?php echo BRAND_LOGO_FILE; ?>" style="width:100px;height:100px" alt="<?php echo BRAND_SHORT_NAME; ?>">
                    <br><br>
                    <h1 class="h4 text-gray-900 mb-1"><?php echo BRAND_SHORT_NAME; ?> Teacher Login</h1>
                    <p class="text-muted mb-4"><?php echo BRAND_COLLEGE_NAME; ?></p>
                  </div>
